...
#Ambient sounds
execute in overworld run schedule function tunnel:stage4/ambientdoor 10
execute in overworld run schedule function tunnel:stage4/ambientlevel 200
...
execute in overworld run schedule function tunnel:stage4/itemframe 10

scoreboard players set MazeComplete Tunnel 0
execute in overworld run schedule function tunnel:stage4/pastbarrier 100
