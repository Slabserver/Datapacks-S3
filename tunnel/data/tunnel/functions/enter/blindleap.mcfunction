...
execute unless entity @s[nbt={Inventory:[{id:"minecraft:spruce_door",tag:{display:{Name:'{"color":"yellow","text":"Anachronistic Door"}'}}}]}] unless entity @s[nbt={Inventory:[{id:"minecraft:spruce_door",tag:{display:{Name:'{"text":"Anachronistic Door","color":"yellow"}'}}}]}] run scoreboard players set @s Tunnel 1
