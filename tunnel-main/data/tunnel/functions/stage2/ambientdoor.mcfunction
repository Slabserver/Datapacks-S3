...
execute if score CurrentLevel Tunnel matches 210..261 if entity @a[scores={TunnelOccupant=1..}] in overworld run schedule function tunnel:stage2/ambientdoor 225
