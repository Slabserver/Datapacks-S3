...
execute if score CurrentLevel Tunnel matches 110..161 if entity @a[scores={TunnelOccupant=1..}] in overworld run schedule function tunnel:stage1/ambientlevel 1000
