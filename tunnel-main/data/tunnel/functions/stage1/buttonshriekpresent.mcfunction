...
execute if entity @a[scores={TunnelOccupant=1..}] in the_end if block 2860 41 2771 minecraft:stone_button[powered=false] in overworld run schedule function tunnel:stage1/buttonshriekpresent 10
