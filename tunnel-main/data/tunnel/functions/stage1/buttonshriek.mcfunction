...
execute if entity @a[scores={TunnelOccupant=1..}] in the_end if block 2851 41 2772 minecraft:stone_button[powered=false] in overworld run schedule function tunnel:stage1/buttonshriek 10
