...
execute if score CurrentLevel Tunnel matches 310..350 if entity @a[scores={TunnelOccupant=1..}] in overworld run schedule function tunnel:stage3/ambientdoor 275
