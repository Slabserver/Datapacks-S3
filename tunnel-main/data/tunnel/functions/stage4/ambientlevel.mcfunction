...
execute if score CurrentLevel Tunnel matches 410 if entity @a[scores={TunnelOccupant=1..}] in overworld run schedule function tunnel:stage4/ambientlevel 1000
